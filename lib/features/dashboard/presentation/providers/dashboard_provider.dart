...
class DashboardNotifier extends StateNotifier<AsyncValue<DashboardData>> {
  ...
  DashboardNotifier(this._repository) : super(const AsyncValue<DashboardData>.loading()) {
    loadDashboard();
  }
  ...
  Future<void> loadDashboard() async {
    ...
    try {
      ...
      state = AsyncValue<DashboardData>.data(data);
    } catch (error, stackTrace) {
      state = AsyncValue<DashboardData>.error(error, stackTrace);
    }
  }
  ...
  void updateUserName(String newName) {
    state.whenData((data) {
      state = AsyncValue<DashboardData>.data(data.copyWith(userName: newName));
    });
  }
}
